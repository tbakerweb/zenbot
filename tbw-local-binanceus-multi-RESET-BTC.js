...
c.mongo.connectionString = process.env.ZENBOT_MONGODB_CONNECTION_STRING || '' // 'mongodb://192.168.1.99:27017/?replicaSet=rs0&readPreference=primary&appname=Zenbot&ssl=false'

// The following is not needed when c.mongo.connectionString is provided:
c.mongo.host = process.env.ZENBOT_MONGODB_HOST || '192.168.1.99'
...
c.mongo.replicaSet = process.env.ZENBOT_MONGO_REPLICASET || null // 'rs0'
c.mongo.authMechanism = process.env.ZENBOT_MONGO_AUTH_MECHANISM || null

// default selector. only used if omitting [selector] argument from a command.
c.selector = process.env.ZENBOT_DEFAULT_SELECTOR || 'binanceus.BTC-USD'
// name of default trade strategy
c.strategy = process.env.ZENBOT_DEFAULT_STRATEGY || 'multi'
...
c.gdax = {}
c.gdax.key = process.env.ZENBOT_GDAX_API_KEY || 'c9d4ec5c69537bd23976f42084d151f7'
c.gdax.b64secret = process.env.ZENBOT_GDAX_B64_SECRET || 'zDQs8pYNwoo5OmyBAlingLQJmSY15xWLhgkeQFH8rteOT+PY3lV0wkGtxsnhFyZtq2xX1bYjy9HpxFf2sWZGaA=='
c.gdax.passphrase = process.env.ZENBOT_GDAX_PASSPHRASE || 'q5xawlmypj'
...
c.binanceus = {}
c.binanceus.key = process.env.ZENBOT_BINANCEUS_API_KEY || '3b3neGaipaZs2wFgGLJWaYpRND71dm5GOrNvd9QwJz4fGaWUEfSujE7bUelNbLV9'
c.binanceus.secret = process.env.ZENBOT_BINANCEUS_SECRET || 'T7AvXkKGWEztWkOsuItKIEGAVNWmU8YLJfIe8Jx83OZkRRV5tCh585Zq7Gyg54mQ'
...
c.sell_stop_pct = process.env.ZENBOT_SELL_STOP_PCT || 99
...
c.profit_stop_enable_pct = process.env.ZENBOT_PROFIT_STOP_ENABLE_PCT || null
// maintain a trailing stop this % below the high-water mark of profit
c.profit_stop_pct = process.env.ZENBOT_PROFIT_STOP_PCT || 0

// Order execution rules:

// avoid trading at a slippage above this pct
c.max_slippage_pct = process.env.ZENBOT_MAX_SLIPPAGE_PCT || 0.025
// buy with this % of currency balance (WARNING : sim won't work properly if you set this value to 100)
c.buy_pct = process.env.ZENBOT_BUY_PCT || 33
// sell with this % of asset balance (WARNING : sim won't work properly if you set this value to 100)
c.sell_pct = process.env.ZENBOT_SELL_PCT || 75
...
c.max_sell_loss_pct = process.env.ZENBOT_MAX_SELL_LOSS_PCT || 5
...
c.markdown_buy_pct = process.env.ZENBOT_MARKDOWN_BUY_PCT || 0.05
// % to mark up sell price for orders
c.markup_sell_pct = process.env.ZENBOT_MARKUP_SELL_PCT || 0.05
...
c.balance_snapshot_period = process.env.ZENBOT_BALANCE_SNAPSHOT_PERIOD || '30m'
// avg. amount of slippage to apply to sim trades
c.avg_slippage_pct = process.env.ZENBOT_AVG_SLIPPAGE_PCT || 0.01
...
c.min_prev_trades = process.env.ZENBOT_MIN_PREV_TRADES || 50000
...
c.notifiers.only_completed_trades = process.env.ZENBOT_NOTIFY_ONLY_COMPLETED_TRADES || true // Filter to notifier's messages for getting Commpleted Trades info.
...
// discord configs
c.notifiers.discord = {}
c.notifiers.discord.on = process.env.ZENBOT_DISCORD_ENABLE || true // false discord disabled; true discord enabled (key should be correct)
c.notifiers.discord.id = process.env.ZENBOT_DISCORD_ID || '758521595949613109'
c.notifiers.discord.token = process.env.ZENBOT_DISCORD_TOKEN || 'rMExeBy9Iy7xlRCEP6Warlq_GZP--qNCUBNhNVQDYpjLVg5dvOj_ul6PuXp-howJCRuk'
c.notifiers.discord.username = process.env.ZENBOT_DISCORD_USERNAME || 'BTC-BinanceUS-Multi'
c.notifiers.discord.avatar_url = process.env.ZENBOT_DISCORD_AVATAR_URL || 'https://tbakerweb.com/zenbot/mario-coin.png'
...
c.output.api.ip = process.env.ZENBOT_API_IP || '192.168.1.99' // IPv4 or IPv6 address to listen on, uses all available interfaces if omitted
c.output.api.port = process.env.ZENBOT_API_PORT || 17361
