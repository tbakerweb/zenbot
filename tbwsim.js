...
c.binanceus = {}
c.binanceus.key = process.env.ZENBOT_BINANCEUS_API_KEY || 'UdVfEToJVpzu0UGg5EGKEWaQULOnG16qyYTcjkuCDuWQZ460gpOvAPuWgsC1aQaA'
c.binanceus.secret = process.env.ZENBOT_BINANCEUS_SECRET || '5U6Do6mi12WeX6djYSRPF6gJUKyapAxKeenW9XxeDRHb3eqOD5c2LsF8gyeY05gt'
...
c.profit_stop_enable_pct = process.env.ZENBOT_PROFIT_STOP_ENABLE_PCT || 0.5
// maintain a trailing stop this % below the high-water mark of profit
c.profit_stop_pct = process.env.ZENBOT_PROFIT_STOP_PCT || 0.5
...
c.max_sell_loss_pct = process.env.ZENBOT_MAX_SELL_LOSS_PCT || 0
// avoid buying at a loss above this pct set to 0 to ensure buying at a lower price...
c.max_buy_loss_pct = process.env.ZENBOT_MAX_BUY_LOSS_PCT || 0
...
c.markdown_buy_pct = process.env.ZENBOT_MARKDOWN_BUY_PCT || 0.4
// % to mark up sell price for orders
c.markup_sell_pct = process.env.ZENBOT_MARKUP_SELL_PCT || 0.4
...
c.notifiers.telegram.bot_token = process.env.ZENBOT_TELEGRAM_BOT_TOKEN || '1252168933:AAEdTGmkE5acxMRRkH8k6FoR1tBbwAfzf00'
c.notifiers.telegram.chat_id = process.env.ZENBOT_TELEGRAM_CHAT_ID || '@tbwcrypto' // the id of the chat the messages should be send in
